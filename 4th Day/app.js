...
// let clikImage=document.querySelector('.click-alert');
// clikImage.addEventListener('click',window.alert("You clicked the image"),false
// );
// let hoverImg=document.querySelector('.hover-alert');
// hoverImg.addEventListener('hover',window.alert("You hovered the image"));